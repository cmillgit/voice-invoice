        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
          <div className="compose-input-bar">
            <textarea
              ...
              rows={1}
              placeholder={hideMic ? 'Type here…' : supported ? 'Tap the mic and speak, or type here…' : 'Voice dictation isn\'t available here — type here, or open this app in Safari (not the installed icon) to dictate…'}
              value={transcript}
